  ...
  void paint(Canvas canvas, Size size) {
    ...
    final shapes = [
      ...
      _FloatingShape(
        ...
        30,
        const Color(0x0DFFFFFF), // white with 5% opacity
      ),
      _FloatingShape(
        Offset(
        ...
        25,
        const Color(0x14FFFFFF), // white with 8% opacity
      ),
      // Medium circles
      _FloatingShape(
        Offset(
        ...
        20,
        const Color(0x0AFFFFFF), // white with 4% opacity
      ),
      _FloatingShape(
        Offset(
        ...
        18,
        const Color(0x0FFFC0CB), // pink with 6% opacity
      ),
      // Small circles
      _FloatingShape(
        Offset(
        ...
        12,
        const Color(0x08FFFFFF), // white with 3% opacity
      ),
      _FloatingShape(
        Offset(
        ...
        15,
        const Color(0x0D800080), // purple with 5% opacity
      ),
    ];
    ...
    final trianglePaint = Paint()
      ..color =
          const Color(0x05FFFFFF) // white with 2% opacity
